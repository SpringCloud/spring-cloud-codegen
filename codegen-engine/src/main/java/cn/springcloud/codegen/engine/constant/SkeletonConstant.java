package cn.springcloud.codegen.engine.constant;
...
public class SkeletonConstant {
    ...
    public static final String MAIN_RESOURCES_FILE_PATH = "src" + FILE_SEPARATOR + "main" + FILE_SEPARATOR + "resources" + FILE_SEPARATOR;
