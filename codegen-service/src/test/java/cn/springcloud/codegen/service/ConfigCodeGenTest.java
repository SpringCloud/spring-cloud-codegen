...
//        String generatePath = SkeletonUtil.getTempGeneratePath();
        ...
        // 模板文件所在的前置路径
        String prefixTemplatePath = "templates/springcloud";
        ...
        String propertiesPath = "config-server/config/skeleton-data.properties";
        ...
        // 输出脚手架文件
        SkeletonService skeletonService = new ConfigCodeGenServiceImpl();
