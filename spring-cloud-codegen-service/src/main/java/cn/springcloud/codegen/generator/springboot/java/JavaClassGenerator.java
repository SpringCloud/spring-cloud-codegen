package cn.springcloud.codegen.generator.springboot.java;
...
public class JavaClassGenerator extends SkeletonJavaGenerator {
     ...
     */
    public JavaClassGenerator(String generatePath, String projectType, String prefixTemplateDirectory, String reducedTemplateDirectory, SkeletonProperties skeletonProperties) {
        super(generatePath, projectType, prefixTemplateDirectory, reducedTemplateDirectory, JavaClassGenerator.class, skeletonProperties);
    }
