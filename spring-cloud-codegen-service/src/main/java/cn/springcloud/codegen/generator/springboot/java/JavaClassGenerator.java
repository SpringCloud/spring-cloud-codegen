...
public class JavaClassGenerator extends SkeletonJavaGenerator {
     ...
     */
    public JavaClassGenerator(String generatePath, String projectType, String prefixTemplatePath, String reducedTemplatePath, SkeletonProperties skeletonProperties) {
        super(generatePath, projectType, prefixTemplatePath, reducedTemplatePath, JavaClassGenerator.class, skeletonProperties);
    }
